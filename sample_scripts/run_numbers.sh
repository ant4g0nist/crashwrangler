...
export CW_LOCK_FILE="numbers.tmp.lck"
...
cp "$1" template.numbers/index.xml
./exc_handler "/Applications/iWork '08/Numbers.app/Contents/MacOS/Numbers" template.numbers &
